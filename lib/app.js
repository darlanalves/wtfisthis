...
module.exports = function(req, res) {
	...
	Request.fetch(urlData.url, function(error, remoteResponse) {
		var result = Response.create(error, remoteResponse);

		result.redirected = false;

		if (remoteResponse._href && remoteResponse._href !== urlData.url) {
